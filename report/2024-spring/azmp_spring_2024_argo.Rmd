...
report_year <- "2024_spring"
path_meta <- "../analysis/common/"

float_meta_data <- read.csv(paste0(path_meta, mission, "float_meta.csv"))
knitr::kable(
  float_meta_data, 
  col.names = gsub("[.]", " ", names(float_meta_data)),
  caption = "Metadata associated with the Argo floats deployed during the Spring AZMP TEL2024880. The WMO and Serial Numbers of each float are provided along with the time and location of deployment.")
```
...
```{r figure 2, include=TRUE, fig.cap="Comparison of Argo sensor data with water samples."}
knitr::include_graphics("figures/spring_initial_profiles_bottle_comparison.png")
```
