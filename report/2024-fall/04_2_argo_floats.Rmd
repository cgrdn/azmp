...
map_path <- "../../analysis/deploymentMaps"
argo_bottle_path <- "../../analysis/comparisonShipArgo"
```
...
# knitr::include_graphics(file.path(map_path, "figures", mission, "deployment_map.png"))
```
...
knitr::kable(table6_df2, 
    ...
    # kableExtra::column_spec(8, width = "3em") %>s
...
knitr::include_graphics(file.path(argo_bottle_path, "figures", mission, "azmp_2024_fall_CTD_bottle_first_profiles.png"))
```
