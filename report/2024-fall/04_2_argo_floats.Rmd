...
table6 <- readr::read_csv(file.path("files", "ArgoFloat_DeploymentMetadata_DY18402.csv"))
...
kbl(table6_df2, 
    ...
    escape = TRUE,
    align = "l",
    col.names = c("IMEI", "S/N", "WMO", "Date", "Ev.", "Stn.", "Magnet Removal (UTC)", "Deploy. (UTC)", "Lat. (DD)", "Lon. (DD)"),
